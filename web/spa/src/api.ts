...
// ------------------------------------------------------------------
// Node egress proxy (透传节点 /settings/api/proxy)
// ------------------------------------------------------------------
export const getNodeProxy = (nodeId: string) =>
  api<NodeProxyInfo>('GET', `/api/admin/nodes/${nodeId}/proxy`);
export const testNodeProxy = (nodeId: string, raw: string) =>
  api<NodeProxyTestResult>('POST', `/api/admin/nodes/${nodeId}/proxy/test`, { raw });
export const setNodeProxy = (nodeId: string, raw: string) =>
  api<NodeProxySetResult>('POST', `/api/admin/nodes/${nodeId}/proxy`, { raw });
